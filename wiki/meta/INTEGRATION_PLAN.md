...
> **From [[The_Story_of_CTC.md]]**: "[Agent] is The [Archetype]—[description]"
...
```markdown
**🎯 New to CTC?** Start with [[The_Story_of_CTC.md]] - A narrative journey from Church's lambda calculus to self-evolving software

**🚀 Getting Started?** See [[../navigation/WELCOME.md]] - Choose your adventure path
```

...
> **From [[The_Story_of_CTC]]**: 0D is **The Sage**—the wise elder, the foundation. The one who knows that sometimes, doing nothing is the right answer. 0D finds fixed points, analyzes graph connectivity, and provides identity. Like the foundation of a building, not glamorous, but everything depends on it.
...
- **[[Dimensional_Progression]]** - How 0D enables 1D-7D
- **[[Multi_Agent_System]]** - How agents coordinate
- **[[Blackboard_Architecture]]** - How knowledge is shared
...
- **[[The_Story_of_CTC]]** - The complete narrative (The Sage's origin story)
- **[[1D_Temporal_Agent]]** - The Chronicler (builds on The Sage)

...
> 💡 **Want the narrative context?** See [[The_Story_of_CTC]] - Learn how the architecture emerged from Church encoding, how agents coordinate, and why this design matters. The story makes the technical details more meaningful.
...
- **[[Getting_Started]]** - Setup and installation (now humanized!)
- **[[API Reference]]** - Detailed API documentation
- **[[Developer Guide]]** - Advanced development topics
- **[[Performance Tuning]]** - Optimization guide

**Related concepts**:
- **[[The_Story_of_CTC]]** - The narrative behind the architecture
- **[[Multi_Agent_System]]** - Deep dive into agents
- **[[Blackboard_Architecture]]** - The coordination pattern

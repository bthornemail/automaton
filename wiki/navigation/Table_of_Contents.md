...
- **🌟 [WELCOME](WELCOME_NEW.md)** - Beautiful landing page with 6 learning paths
- **📖 [The Story of CTC](../meta/The_Story_of_CTC.md)** - Complete narrative journey (10,000+ words)
- **📚 [Humanization Guide](../guides/HUMANIZATION_GUIDE.md)** - How we write documentation
...
- **[Dimensional Chain](../vertical/dimensional-chain.md)** - 0D→1D→2D→...→7D chain

...
**Who conducts?** No one. The agents coordinate through the blackboard—like musicians watching each other, responding to the music.
...
**Where does coordination happen?** Through the blackboard—a shared knowledge base where agents read and write.
...
> 💡 **Want the complete story?** See [[../../meta/The_Story_of_CTC.md]] - Learn how the multi-agent system emerged, how agents coordinate, and why this architecture matters.
...
- **Tool mappings**: Read/Glob/Grep → 2D, Edit/Write → 3D, Bash → 4D, Task → 6D, Todo → 5D
- **CLI interface**: Command-line access to CTC

---

## 🎼 How Agents Coordinate: The Orchestra in Action
...
**The insight**: Coordination emerges from the blackboard. Agents don't need to know about each other—they coordinate through the blackboard.
...
**The metaphor**: Like musicians in an orchestra. They don't talk directly—they watch the conductor (blackboard) and listen to each other.
...
**Responsibilities**:
- **Tool mappings**: CLI tools → dimensional operations
...
## 🎓 Learning from the Multi-Agent System
...
## 🎯 When to Use the Multi-Agent System
...
- ✅ Problems require multiple agents
...
## 🌟 The Wisdom of the Multi-Agent System
...
- ✅ CTC has 15 specialized agents
- ✅ Agents coordinate through the blackboard
- ✅ Each agent specializes in its dimension
- ✅ Coordination enables integration
- ✅ The system is an orchestra of specialists

...
export class TopicSlideGenerator {
  constructor(agentCoordinator, contentLoader) {
   ...
   * @returns {Promise<Object>} Generated slide
   */
  async generateSlideFromTopic(topic, options = {}) {
   ...
   */
  inferDimensionFromTopic(topic, explicitDimension = null) {
   ...
   */
  inferPartitionFromTopic(topic, explicitPartition = null) {
   ...
   */
  findMatchingEntries(topic, dimension, partition, allEntries) {
    const matches = [];
   ...
   */
  generateBQFMetadata(dimension, partition) {
   ...
   */
  generateTitle(topic, dimension, matchingEntries) {
   ...
   */
  generateDescription(topic, dimension, matchingEntries) {
   ...
   */
  generateContent(topic, dimension, matchingEntries) {
    const contentParts = [];
    ...
    if (dimension) {
      const partition = this.inferPartitionFromTopic(topic);
